...
import { SectionTitle, Card, CardTitle, CardDescription } from '@/components/ui';
  ...
  return (
    <section id="features" className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          title={t('title')}
          subtitle="스마트한 소비생활을 위한 모든 기능이 하나의 앱에"
          align="center"
        />
          ...
          {features.map((feature, index) => (
            ...
            >
              <Card
                ...
                rounded="lg"
                hoverable
                className="group bg-gray-50 transition-all hover:bg-white hover:shadow-xl"
              >
                <div
                ...
                <CardDescription>{t(`${feature.key}.description`)}</CardDescription>
              </Card>
            </motion.div>
          ))}
        </div>
