...
const socialLinks = [
  {
    name: 'Yellow Winnie',
    url: 'https://yellow.mywinnie.com/winnie-creative-studio',
    icon: (
  ...
  {
    name: 'TikTok',
    url: 'https://www.tiktok.com/@winnie.creative',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/winnie.creative.studio',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/winnie.creative.studio',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Threads',
    url: 'https://www.threads.net/@winnie.creative.studio',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <a
            href="https://yellow.mywinnie.com/winnie-creative-studio"
            target="_blank"
            rel="noopener noreferrer"
